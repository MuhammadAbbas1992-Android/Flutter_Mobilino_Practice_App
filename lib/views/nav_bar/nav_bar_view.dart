...
import 'package:mobilino/view_models/services/nav_bar/nav_bar_service.dart';
...
class NavBarView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final navBarServices = NavBarService();
    return PopScope(
      canPop: false,
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                InkWell(
                  onTap: () => navBarServices.navigatePage(RoutsName.homeView),
